...
MEM_CONFIG_PHYPADCFG MemPhyPadCfg_rs600_x8 = {
  {
    ...
    .BoardMask      = RS600_64G_x8_MASK | RS600_64G_RAYSON_MASK
  },
  {
...
MEM_CONFIG_PHYPADCFG MemPhyPadCfg_Hive_Semi = {
  {
    .Signature      = MEM_CONFIG_BLOCK_PHYPADCFG_SIGNATURE,
    .BlockSize      = sizeof(MEM_CONFIG_PHYPADCFG) + sizeof(MEM_CONFIG_PHYPADCFG_ENTRY) * ENTRY_COUNT,
    .BoardMask      = RS600_24G_HS_MASK | RS600_48G_HS_MASK | RS600_32G_x8_HS_MASK | RS600_16G_HS_MASK
  },
  {
    // MaxMemFreq       RankPerCh DqDrv   DqOdt   DqsDrv  DqsOdt  CkDrv   CaDrv   CsDrv   CkeDrv  FdbkDrv FdbkOdt  RstDrv FFE DFE CTLE
    {DDR5500_FREQUENCY, RANK_ALL, IMP_34, IMP_40, IMP_34, IMP_40, IMP_40, IMP_40, IMP_40, IMP_40, IMP_34, IMP_40,  IMP_34, 1,  0, 0x0},
    {DDR6400_FREQUENCY, RANK_ALL, IMP_34, IMP_40, IMP_34, IMP_40, IMP_40, IMP_40, IMP_40, IMP_40, IMP_34, IMP_40,  IMP_34, 0,  0, 0x1b},
  }
};

MEM_CONFIG_PHYPADCFG MemPhyPadCfg_Hynix = {
  {
    .Signature      = MEM_CONFIG_BLOCK_PHYPADCFG_SIGNATURE,
    .BlockSize      = sizeof(MEM_CONFIG_PHYPADCFG) + sizeof(MEM_CONFIG_PHYPADCFG_ENTRY) * ENTRY_COUNT,
