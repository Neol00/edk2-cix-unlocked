...
fpTrans_fp C_Trans[NumNodeTypes+1] = {
	NULL,
	NULL,					/* See next table.
Junctions have many types */
	(fpTrans_fp) genRuleRef,
	(fpTrans_fp) genToken,
	(fpTrans_fp) genAction
 };

/* C_JTrans[Junction type] == pointer to function that knows how to translate that
 * kind of junction node.
 */
fpTrans_fp C_JTrans[NumJuncTypes+1] = {
	NULL,
	(fpTrans_fp) genSubBlk,
	(fpTrans_fp) genOptBlk,
	(fpTrans_fp) genLoopBlk,
	(fpTrans_fp) genEndBlk,
	(fpTrans_fp) genRule,
	(fpTrans_fp) genJunction,
	(fpTrans_fp) genEndRule,
	(fpTrans_fp) genPlusBlk,
	(fpTrans_fp) genLoopBegin
 };
