 ...
 */
fpTraverse_fp fpTraverse[NumNodeTypes+1] = {
	NULL,
	(fpTraverse_fp) tJunc,
	(fpTraverse_fp) tRuleRef,
	(fpTraverse_fp) tToken,
	(fpTraverse_fp) tAction
};
 ...
 */
fpReach_fp fpReach[NumNodeTypes+1] = {
	NULL,
	(fpReach_fp) rJunc,
	(fpReach_fp) rRuleRef,
	(fpReach_fp) rToken,
...
fpPrint_fp fpPrint[NumNodeTypes+1] = {
	NULL,
	(fpPrint_fp) pJunc,
	(fpPrint_fp) pRuleRef,
	(fpPrint_fp) pToken,
...
fpTrans_fp	*fpTrans;		/* array of ptrs to funcs that translate nodes */
fpTrans_fp	*fpJTrans;		/*  ... that translate junctions */
