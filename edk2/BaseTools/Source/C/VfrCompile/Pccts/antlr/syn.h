...
/*
 * Function pointer typedefs for polymorphic dispatch tables.
 * The actual functions have more specific first-argument types
 * (Junction *, TokNode *, etc.) but are cast to these common types.
 */
typedef struct _tree *(*fpTraverse_fp)(void *, int, set *);
typedef set (*fpReach_fp)(void *, int, set *);
typedef void (*fpPrint_fp)(void *);
typedef void (*fpTrans_fp)(void *);
